  ...
  (0, _createClass3.default)(smartPhoto, [{
    ...
    value: function onUpdated() {
      ...
      if (this.data.appearEffect && this.data.appearEffect.once) {
        ...
        setTimeout(function () {
          var $img = (0, _zeptoBrowserify.$)('.' + classNames.smartPhotoImg, '[data-id="' + _this4.id + '"]');
          $img.addClass('active');
          if (document.querySelector('[data-id="' + _this4.id + '"] .current .' + classNames.smartPhotoLoader)) {
            _this4._loadCurrentItem().then(function () {
              _this4.data.appearEffect = null;
              _this4.data.appear = true;
              _this4._resetTranslate();
    ...
    key: '_loadCurrentItem',
    value: function _loadCurrentItem() {
      var _this6 = this;

      return new _promise2.default(function (resolve, reject) {
        var img = new Image();
        var currentItem = _this6._getCurrentItemByHash();
        img.onload = function () {
