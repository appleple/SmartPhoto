    ...
    value: function addNewItem(element) {
      ...
      var clickHandler = function clickHandler(event) {
        ...
        var onFocus = function onFocus(e) {
          if (e.keyCode === 9) {
            var smartPhoto = document.querySelector(".".concat(_this3.data.classNames.smartPhoto));
            var arrows = document.querySelector(".".concat(_this3.data.classNames.smartPhotoArrows));
            var dismiss = document.querySelector(".".concat(_this3.data.classNames.smartPhotoDismiss));
