...
var smartPhoto = function (_aTemplate) {
  ...
  _createClass(smartPhoto, [{
    ...
    value: function _slideList() {
      ...
      var classNames = this.data.classNames;
      var list = this._getElementByClass(classNames.smartPhotoList);
      var handler = function handler() {
        _this10.data.onMoveClass = false;
        var date = new Date();
        _this10.setArrow();
        _this10.updateDebounce();
    ...
    value: function zoomPhoto() {
      ...
      this.data.photoPosX = 0;
      this.data.photoPosY = 0;
      var img = this._getElementByQuery('.current .' + classNames.smartPhotoImg);
      var handler = function handler() {
