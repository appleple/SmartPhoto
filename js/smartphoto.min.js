        ...
        function (e, a, o) {
          (function (e, a) {
            !(function (e) {
              ...
              function l(t, e) {
                t.state_ === w && ((t.state_ = E), (t.data_ = e), r(p, t));
              }
              function h(t, e) {
                t.state_ === w && ((t.state_ = E), (t.data_ = e), r(m, t));
              }
              function f(t) {
                var e = t.then_;
                t.then_ = void 0;
              ...
              (v.prototype = {
                ...
                data_: void 0,
                then: function (t, e) {
                  var a = { owner: this, then: new this.constructor(_), fulfilled: t, rejected: e };
                  return (
                    this.state_ === P || this.state_ === b ? r(c, a) : this.then_.push(a), a.then
                  );
                },
                catch: function (t) {
            ...
            I = (function (t) {
              return function (e, a, o) {
                ...
                if (!C)
                  if (z === E)
                    X === E
                      ? c(e, a) || (T(e), (L = u(e, d(a.nodeName, a.namespaceURI))))
                      : (L = a);
                  else if (z === b || z === _) {
                    if (X === z)
                      return L.nodeValue !== a.nodeValue && (L.nodeValue = a.nodeValue), L;
                    L = a;
                  }
                if (L === a) T(e);
                else {
                ...
                r(e, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var t = this,
                        e =
                          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'bottom';
                      (this.data.hide = !0),
                        (this.data.appear = !1),
