...
},{"morphdom":90,"zepto-browserify":2}],2:[function(require,module,exports){
...
},{"regenerator-runtime":92}],15:[function(require,module,exports){
require('../../modules/es6.object.create');
var $Object = require('../../modules/_core').Object;
module.exports = function create(P, D){
  return $Object.create(P, D);
};
},{"../../modules/_core":26,"../../modules/es6.object.create":80}],16:[function(require,module,exports){
require('../../modules/es6.object.define-property');
var $Object = require('../../modules/_core').Object;
module.exports = function defineProperty(it, key, desc){
  return $Object.defineProperty(it, key, desc);
};
},{"../../modules/_core":26,"../../modules/es6.object.define-property":81}],17:[function(require,module,exports){
...
},{"../../modules/_wks-ext":77,"../../modules/es6.string.iterator":85,"../../modules/web.dom.iterable":89}],21:[function(require,module,exports){
...
},{"./_export":33,"./_set-proto":64}],84:[function(require,module,exports){
...
},{"./_iter-define":44,"./_string-at":68}],86:[function(require,module,exports){
'use strict';
...
},{"./_global":35,"./_hide":37,"./_iterators":46,"./_wks":78,"./es6.array.iterator":79}],90:[function(require,module,exports){
'use strict';
...
},{"../index":98}],96:[function(require,module,exports){
'use strict';
...
var _marked = [getUniqId, getIndex].map(_regenerator2.default.mark);
...
function getUniqId(limit) {
  ...
  return _regenerator2.default.wrap(function getUniqId$(_context2) {
    while (1) {
...
function getIndex() {
  var i;
  return _regenerator2.default.wrap(function getIndex$(_context3) {
    while (1) {
...
var idGen = getUniqId(10);
var indexGen = getIndex();
...
var coolPhoto = function (_aTemplate) {
  ...
  function coolPhoto(selector, settings) {
    ...
    var _this2 = (0, _possibleConstructorReturn3.default)(this, (coolPhoto.__proto__ || (0, _getPrototypeOf2.default)(coolPhoto)).call(this));

    _this2.data = util.extend({}, defaults, settings);
    _this2.data.currentIndex = 0;
    _this2.data.hide = true;
    _this2.data.items = [];
    _this2.pos = { x: 0, y: 0 };
    _this2.elements = document.querySelectorAll(selector);
    _this2.id = idGen.next().value;
    _this2.addTemplate(_this2.id, template);
    (0, _zeptoBrowserify.$)('body').append('<div data-id=\'' + _this2.id + '\'></div>');
    _this2.update();
    [].forEach.call(_this2.elements, function (element, index) {
      _this2.addNewItem(element, index);
    });
    (0, _zeptoBrowserify.$)(window).resize(function () {
      _this2.data.translateY = _this2.update();
    });
    return _this2;
  }
  ...
  (0, _createClass3.default)(coolPhoto, [{
    ...
    value: function hidePhoto() {
      if ((0, _zeptoBrowserify.$)(this.e.target).hasClass(this.data.classNames.coolPhotoInner)) {
        this.data.hide = true;
        this.update();
      }
    }
...
module.exports = "<div class=\"\\{classNames.coolPhoto\\}\"<!-- BEGIN hide:exist --> style=\"display:none;\"<!-- END hide:exist -->>\n\t<div class=\"\\{classNames.coolPhotoBody\\}\" data-action-click=\"hidePhoto\">\n\t\t<div class=\"\\{classNames.coolPhotoInner\\}\">\n\t\t\t\t<ul style=\"transform:translateX({translateX}px);\" class=\"\\{classNames.coolPhotoList\\}<!-- BEGIN onMoveClass:exist --> \\{classNames.coolPhotoListOnMove\\}<!-- END onMoveClass:exist -->\" data-action-mousedown=\"beforeDrag\" data-action-mouseup=\"afterDrag\" data-action-mousemove=\"onDrag\" data-action-click=\"zoomPhoto\">\n\t\t\t\t\t<!-- BEGIN items:loop -->\n\t\t\t\t\t<li style=\"transform:translateX({translateX}px);\"><img src=\"{src}\" class=\"\\\\{classNames.coolPhotoImg\\\\}\"></li>\n\t\t\t\t\t<!-- END items:loop -->\n\t\t\t\t</ul>\n\t\t\t\t<!-- BEGIN arrows:exist -->\n\t\t\t\t\t<ul class=\"\\{classNames.coolPhotoArrows\\}\">\n\t\t\t\t\t\t\t<!-- BEGIN itemPrev:exist -->\n\t\t\t\t\t\t\t<li class=\"\\{classNames.coolPhotoArrowLeft\\}\" data-index=\"{prevIndex}\"></li>\n\t\t\t\t\t\t\t<!-- END itemPrev:exist -->\n\n\t\t\t\t\t\t\t<!-- BEGIN itemNext:exist -->\n\t\t\t\t\t\t\t<li class=\"\\{classNames.coolPhotoArrowRight\\}\" data-index=\"{nextIndex}\"></li>\n\t\t\t\t\t\t\t<!-- END itemNext:exist -->\n\t\t\t\t\t</ul>\n\t\t\t\t<!-- END arrows:exist -->\n\t\t\t\t<!-- BEGIN nav:exist -->\n\t\t\t\t<ul class=\"\\{classNames.coolPhotoNav\\}\">\n\t\t\t\t\t<!-- BEGIN items:loop -->\n\t\t\t\t\t<li><img src=\"{src}\"></li>\n\t\t\t\t\t<!-- END items:loop -->\n\t\t\t\t</ul>\n\t\t\t\t<!-- END nav:exist -->\n\t\t</div>\n\t</div>\n</div>\n";
...
},{"babel-runtime/helpers/typeof":13}]},{},[95]);
