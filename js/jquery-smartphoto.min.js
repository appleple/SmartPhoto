                  ...
                  value: function (t) {
                    ...
                    var u = function (a) {
                      ...
                      var o = e._getSelectedItem(),
                        n = function (t) {
                          var a = document.querySelector('.'.concat(e.data.classNames.smartPhoto)),
                            o = document.querySelector(
                              '.'.concat(e.data.classNames.smartPhotoArrows)
                            ),
                            n = document.querySelector(
                              '.'.concat(e.data.classNames.smartPhotoDismiss)
                            ),
                      ...
                      if (o.loaded) {
                        e._initPhoto(),
                          ...
                          e._fireEvent('open');
                        document.querySelector('.'.concat(e.data.classNames.smartPhoto)).focus(),
                        ...
                        e._loadItem(o).then(function () {
                          e._initPhoto(),
                            ...
                            e._fireEvent('open'),
                            document
                              .querySelector('.'.concat(e.data.classNames.smartPhoto))
                              .focus(),
                            document.addEventListener('keydown', n),
                            e._registerRemoveEvent(window, 'keydown', n);
                        });
