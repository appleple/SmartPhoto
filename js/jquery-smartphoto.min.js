                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    (0, c.on)(t, h, d, function (t) {
                      ...
                      this.events.push({ element: t, selector: h, event: u });
                  },
                },
                {
                          ...
                          ? (a
                              ? a !== o &&
                                ((d = O[a])
                                  ? i === d
                                    ? (f = !1)
                                    : (t.insertBefore(d, h), o ? n(o) : r(h, t, !0), (h = d))
                                  : (f = !1))
                              : o && (f = !1),
                            (f = !1 !== f && c(h, u)) && v(h, u))
                          : (l !== b && l != _) ||
                            ((f = !0), h.nodeValue !== u.nodeValue && (h.nodeValue = u.nodeValue))),
                      f)
                    ) {
                      (u = s), (h = i);
                      continue t;
            ...
            function e(t, a) {
              ...
              if (
                ...
                return (
                  ...
                  o._registerRemoveEvent(window, 'keydown', h),
                  s(o)
                );
              }
              var l = function () {
              ...
              if (
                ...
                o._registerRemoveEvent(window, 'orientationchange', l),
              ...
              r(e, [
                  ...
                  value: function (t) {
                    ...
                    var u = function (a) {
                      ...
                      o.loaded
                        ...
                        document.addEventListener('keydown', e._onFocus.bind(e)),
                        e._registerRemoveEvent(window, 'keydown', e._onFocus);
                    };
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if ((p.triggerEvent(e, t), 'open' === t)) {
                      this._getElementByClass(
                ...
                },
                {
                  key: '_onFocus',
                  value: function (t) {
                    var e = this._getElementByClass(
                        "[data-id='".concat(this.data.classNames.smartPhoto, "']")
                      ),
                      a = this._getElementByClass(
                        "[data-id='".concat(this.data.classNames.smartPhotoDismiss, "']")
                      ),
                      o = document.activeElement;
                    'Tab' !== t.key || t.shiftKey || (o === a && (t.preventDefault(), e.focus())),
                      'Tab' === t.key && t.shiftKey && o === e && (t.preventDefault(), a.focus());
                  },
                },
              ]),
              e
