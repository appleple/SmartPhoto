...
})()(
  {
              ...
              i(t, [
                ...
                },
                {
                  ...
                  value: function (t) {
                    for (
                      ...
                      e += a.charAt(Math.floor(this.getRand(0, o)));
                    return e;
                  },
                },
                {
                  ...
                  value: function (t, e, a) {
                    ...
                    if (n)
                      for (var c = 0, d = n.length; c < d; c += 1) {
                        ...
                        var l = u.replace(/BEGIN/, 'END'),
                          h = new RegExp(u + '(([\\n\\r\\t]|.)*?)' + l, 'g');
                        t = t.replace(h, function (t, a, n, i) {
                          return '' +
                            ('function' == typeof e[a] ? e[a].apply(o) : o.getDataFromObj(a, e)) ===
                            n
                            ? i
                            : '';
                        });
                    ...
                    if (r)
                      for (var y = 0, x = r.length; y < x; y += 1) {
                        ...
                        var E = w.replace(/BEGIN/, 'END'),
                          P = new RegExp(w + '(([\\n\\r\\t]|.)*?)' + E, 'g');
                        t = t.replace(P, function (t, a, n) {
                          var i =
                            'function' == typeof e[a] ? e[a].apply(o) : o.getDataFromObj(a, e);
                          return i || 0 === i ? n : '';
                        });
                    ...
                    return (t = t.replace(
                      ...
                      function (t, n, i, r) {
                        ...
                        if ('' + n == 'i') s = a;
                          ...
                          if (!e[n] && 0 !== e[n])
                            return r && o.convert && o.convert[r] ? o.convert[r].call(o, '') : '';
                  ...
                  value: function (t) {
                    ...
                    return (t = t.replace(e, function (t, e, o) {
                      ...
                      if (i instanceof Array)
                        for (var s = 0, c = i.length; s < c; s += 1)
                          r += a.resolveBlock(o, i[s], s);
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    var n = this.data;
                    for (o = this.resolveInclude(o), o = this.resolveWith(o); this.hasLoop(o); )
                      o = this.resolveLoop(o);
                    return (
                      (o = this.resolveBlock(o, n)),
                      (o = o.replace(/\\([^\\])/g, '$1')),
                    ...
                    for (var n = 0, i = o.length; n < i; n += 1)
                      !(function (n, i) {
                        ...
                        if (l)
                          ...
                          (0, c.selector)(d).insertAdjacentHTML(
                            'afterend',
                            '<div data-id="' + r + '"></div>'
                          ),
                            'text' === e
                              ? ((0, c.selector)("[data-id='" + r + "']").innerText = u)
                              : ((0, c.selector)("[data-id='" + r + "']").innerHTML = u);
                        var p = t.atemplate.find(function (t) {
                          return t.id === r;
                        });
                        p.binded ||
                          ((p.binded = !0),
                          t.addDataBind((0, c.selector)("[data-id='" + r + "']")),
                          t.addActionBind((0, c.selector)("[data-id='" + r + "']")));
                      })(n);
                  ...
                  value: function (t) {
                    for (var e = this, a = this.templates, o = 0, n = a.length; o < n; o += 1) {
                      ...
                      [].forEach.call(s, function (t) {
                        ...
                        'checkbox' === t.getAttribute('type') || 'radio' === t.getAttribute('type')
                          ? a === t.value && (t.checked = !0)
                          : (t.value = a);
                      });
                ...
                },
                {
                  ...
                  value: function (t) {
                    for (
                      var e, a = arguments.length, o = Array(a > 1 ? a - 1 : 0), n = 1;
                      n < a;
                      n++
                    )
                      o[n - 1] = arguments[n];
    ...
    2: [
      function (t, e, a) {
        ...
        var o = (a.matches = function (t, e) {
            for (
              var a = (t.document || t.ownerDocument).querySelectorAll(e), o = a.length;
              --o >= 0 && a.item(o) !== t;
        ...
        (a.on = function (t, e, a, o) {
          ...
          a.split(' ').forEach(function (a) {
            ...
            i.push({ listener: s, element: t, query: e, event: a, capture: r }),
            ...
            a.split(' ').forEach(function (a) {
              i.forEach(function (o, n) {
                o.element === t &&
                  o.query === e &&
                  o.event === a &&
                  (t.removeEventListener(a, o.listener, o.capture), i.splice(n, 1));
              });
            });
          });
      },
        ...
        (function (t, e) {
          !(function (t) {
            ...
            (m.prototype = {
              ...
              data_: void 0,
              then: function (t, e) {
                var a = { owner: this, then: new this.constructor(b), fulfilled: t, rejected: e };
                return (
                  this.state_ === E || this.state_ === P ? i(s, a) : this.then_.push(a), a.then
                );
              },
              catch: function (t) {
              ...
              (m.all = function (t) {
                ...
                return new e(function (e, a) {
                  for (var o, n = [], i = 0, r = 0; r < t.length; r++)
                    (o = t[r]),
              ...
              (m.race = function (t) {
                ...
                return new e(function (e, a) {
                  for (var o, n = 0; n < t.length; n++)
                    (o = t[n]), o && 'function' == typeof o.then ? o.then(e, a) : e(o);
                });
              }),
    ...
    6: [
      function (t, e, a) {
          ...
          if (e.nodeType !== m && t.nodeType !== m) {
            for (var s = r.length - 1; s >= 0; s--)
              (a = r[s]),
                ...
                n
                  ? ((o = a.localName || o),
                    t.getAttributeNS(n, o) !== i &&
                      ('xmlns' === a.prefix && (o = a.name), t.setAttributeNS(n, o, i)))
                  : t.getAttribute(o) !== i && t.setAttribute(o, i);
            for (var c = t.attributes, d = c.length - 1; d >= 0; d--)
              (a = c[d]),
                (o = a.name),
                (n = a.namespaceURI),
                n
                  ? ((o = a.localName || o), e.hasAttributeNS(n, o) || t.removeAttributeNS(n, o))
                  : e.hasAttribute(o) || t.removeAttribute(o);
          }
        }
        function n(t) {
        ...
        function i(t) {
          return (
            p || ((p = g.createRange()), p.selectNode(g.body)),
            p.createContextualFragment(t).childNodes[0]
          );
        }
        function r(t) {
        ...
        function c(t, e) {
          ...
          return (
            a === o ||
            (!!(e.actualize && a.charCodeAt(0) < 91 && o.charCodeAt(0) > 90) &&
              a === o.toUpperCase())
          );
        }
        function d(t, e) {
        ...
        var p,
          ...
          w = {
            OPTION: function (t, e) {
              ...
              if (a) {
                ...
                'OPTGROUP' === o && ((a = a.parentNode), (o = a && a.nodeName.toUpperCase())),
                  'SELECT' !== o ||
                    a.hasAttribute('multiple') ||
                    (t.hasAttribute('selected') &&
                      !e.selected &&
                      (t.setAttribute('selected', 'selected'), t.removeAttribute('selected')),
                    (a.selectedIndex = -1));
              }
              l(t, e, 'selected');
            },
            ...
            SELECT: function (t, e) {
              if (!e.hasAttribute('multiple')) {
                for (var a, o, n = -1, i = 0, r = t.firstChild; r; )
                  if ('OPTGROUP' === (o = r.nodeName && r.nodeName.toUpperCase()))
                    (a = r), (r = a.firstChild);
                  else {
                    if ('OPTION' === o) {
          ...
          I = (function (t) {
            return function (e, a, o) {
              ...
              function l(t) {
                if (t.nodeType === E || t.nodeType === P)
                  for (var e = t.firstChild; e; ) {
                    var a = I(e);
                    a && (O[a] = e), l(e), (e = e.nextSibling);
                  }
              }
              function p(t) {
                S(t);
              ...
              function y(t, e) {
                ...
                t: for (; u; ) {
                  for (s = u.nextSibling, a = I(u); l; ) {
                    if (((i = l.nextSibling), u.isSameNode && u.isSameNode(l))) {
                      (u = s), (l = i);
                      continue t;
                    }
                    o = I(l);
                          ...
                          ? (a
                              ? a !== o &&
                                ((d = O[a])
                                  ? i === d
                                    ? (f = !1)
                                    : (t.insertBefore(d, l), o ? n(o) : r(l, t, !0), (l = d))
                                  : (f = !1))
                              : o && (f = !1),
                            (f = !1 !== f && c(l, u)) && v(l, u))
                          : (h !== b && h != _) ||
                            ((f = !0), l.nodeValue !== u.nodeValue && (l.nodeValue = u.nodeValue))),
                      f)
                    ) {
                      (u = s), (l = i);
                      continue t;
                  ...
                  if (a && (d = O[a]) && c(d, u)) t.appendChild(d), v(d, u);
                  else {
                    var y = N(u);
                    !1 !== y &&
                      (y && (u = y),
                      u.actualize && (u = u.actualize(t.ownerDocument || g)),
                      t.appendChild(u),
                      p(u));
                  }
                  (u = s), (l = i);
              ...
              if (!C)
                if (z === E)
                  X === E ? c(e, a) || (T(e), (L = u(e, d(a.nodeName, a.namespaceURI)))) : (L = a);
                else if (z === b || z === _) {
              ...
              return (
                !C &&
                  L !== e &&
                  e.parentNode &&
                  (L.actualize && (L = L.actualize(e.ownerDocument || g)),
    ...
    10: [
      function (t, e, a) {
        ...
        var f =
            '<div\n\tclass="\\{classNames.smartPhoto\\}"\x3c!-- BEGIN hide:exist --\x3e\n\taria-hidden="true"\x3c!-- END hide:exist --\x3e\x3c!-- BEGIN hide:empty --\x3earia-hidden="false"\x3c!-- END hide:empty --\x3e\n\trole="dialog"\n\ttabindex="0">\n\t<div class="\\{classNames.smartPhotoBody\\}">\n\t\t<div class="\\{classNames.smartPhotoInner\\}">\n\t\t\t<div class="\\{classNames.smartPhotoHeader\\}">\n\t\t\t\t<span class="\\{classNames.smartPhotoCount\\}">{currentIndex}[increment]/{total}</span>\n\t\t\t\t<span class="\\{classNames.smartPhotoCaption\\}" aria-live="polite">\x3c!-- BEGIN groupItems:loop --\x3e\x3c!-- \\BEGIN currentIndex:touch#{index} --\x3e{caption}\x3c!-- \\END currentIndex:touch#{index} --\x3e\x3c!-- END groupItems:loop --\x3e</span>\n\t\t\t</div>\n\n\t\t\t<div class="\\{classNames.smartPhotoContent\\}"\x3c!-- BEGIN isSmartPhone:exist --\x3e data-action-touchstart="beforeDrag" data-action-touchmove="onDrag" data-action-touchend="afterDrag(false)"\x3c!-- END isSmartPhone:exist --\x3e\x3c!-- BEGIN isSmartPhone:empty --\x3e data-action-click="hidePhoto()"\x3c!-- END isSmartPhone:empty --\x3e>\n\t\t\t</div>\n\n\t\t\t<ul\n\t\t\t\tstyle="transform:translate({translateX}[round]px,{translateY}[round]px);"\n\t\t\t\tclass="\\{classNames.smartPhotoList\\}\x3c!-- BEGIN onMoveClass:exist --\x3e \\{classNames.smartPhotoListOnMove\\}\x3c!-- END onMoveClass:exist --\x3e">\n\t\t\t\t\x3c!-- BEGIN groupItems:loop --\x3e\n\t\t\t\t<li style="transform:translate({translateX}[round]px,{translateY}[round]px);" class="\x3c!-- \\BEGIN currentIndex:touch#{index} --\x3ecurrent\x3c!-- \\END currentIndex:touch#{index} --\x3e">\n\t\t\t\t\t\x3c!-- BEGIN processed:exist --\x3e\n\t\t\t\t\t<div\n\t\t\t\t\t\tstyle="transform:translate({x}[round]px,{y}[round]px) scale({scale});"\n\t\t\t\t\t\tclass="\\\\{classNames.smartPhotoImgWrap\\\\}"\x3c!-- \\BEGIN isSmartPhone:empty --\x3e\n\t\t\t\t\t\tdata-action-mousemove="onDrag"\n\t\t\t\t\t\tdata-action-mousedown="beforeDrag"\n\t\t\t\t\t\tdata-action-mouseup="afterDrag"\x3c!-- \\END isSmartPhone:empty --\x3e\x3c!-- \\BEGIN isSmartPhone:exist --\x3e\n\t\t\t\t\t\tdata-action-touchstart="beforeDrag"\n\t\t\t\t\t\tdata-action-touchmove="onDrag"\n\t\t\t\t\t\tdata-action-touchend="afterDrag"\x3c!-- \\END isSmartPhone:exist --\x3e>\n\t\t\t\t\t\t<img style="\x3c!-- \\BEGIN currentIndex:touch#{index} --\x3etransform:translate(\\{photoPosX\\}[virtualPos]px,\\{photoPosY\\}[virtualPos]px) scale(\\{scaleSize\\});\x3c!-- \\END currentIndex:touch#{index} --\x3ewidth:{width}px;" src="{src}" class="\\\\{classNames.smartPhotoImg\\\\}\x3c!-- \\BEGIN scale:exist --\x3e  \\\\{classNames.smartPhotoImgOnMove\\\\}\x3c!-- \\END scale:exist --\x3e\x3c!-- \\BEGIN elastic:exist --\x3e \\\\{classNames.smartPhotoImgElasticMove\\\\}\x3c!-- \\END elastic:exist --\x3e\x3c!-- \\BEGIN appear:exist --\x3e active\x3c!-- \\END appear:exist --\x3e" ondragstart="return false;">\n\t\t\t\t\t</div>\n\t\t\t\t\t\x3c!-- END processed:exist --\x3e\n\t\t\t\t\t\x3c!-- BEGIN processed:empty --\x3e\n\t\t\t\t\t<div class="\\\\{classNames.smartPhotoLoaderWrap\\\\}">\n\t\t\t\t\t\t<span class="\\\\{classNames.smartPhotoLoader\\\\}"></span>\n\t\t\t\t\t</div>\n\t\t\t\t\t\x3c!-- END processed:empty --\x3e\n\t\t\t\t</li>\n\t\t\t\t\x3c!-- END groupItems:loop --\x3e\n\t\t\t</ul>\n\n\t\t\t\x3c!-- BEGIN arrows:exist --\x3e\n\t\t\t<ul\n\t\t\t\tclass="\\{classNames.smartPhotoArrows\\}"\x3c!-- BEGIN hideUi:exist --\x3e\n\t\t\t\taria-hidden="true"\x3c!-- END hideUi:exist --\x3e\x3c!-- BEGIN hideUi:exist --\x3e\n\t\t\t\taria-hidden="false"\x3c!-- END hideUi:exist --\x3e>\n\t\t\t\t<li\n\t\t\t\t\tclass="\\{classNames.smartPhotoArrowLeft\\}\x3c!-- BEGIN isSmartPhone:exist --\x3e \\{classNames.smartPhotoArrowHideIcon\\}\x3c!-- END isSmartPhone:exist --\x3e"\x3c!-- BEGIN showPrevArrow:empty --\x3e\n\t\t\t\t\taria-hidden="true"\x3c!-- END showPrevArrow:empty --\x3e>\n\t\t\t\t\t<a\n\t\t\t\t\t\thref="#"\n\t\t\t\t\t\tdata-action-click="gotoSlide({prev})"\n\t\t\t\t\t\trole="button">\n\t\t\t\t\t\t<span class="smartphoto-sr-only">\\{message.gotoPrevImage\\}</span>\n\t\t\t\t\t</a>\n\t\t\t\t</li>\n\t\t\t\t<li\n\t\t\t\t\tclass="\\{classNames.smartPhotoArrowRight\\}\x3c!-- BEGIN isSmartPhone:exist --\x3e \\{classNames.smartPhotoArrowHideIcon\\}\x3c!-- END isSmartPhone:exist --\x3e"\x3c!-- BEGIN showNextArrow:empty --\x3e\n\t\t\t\t\taria-hidden="true"\x3c!-- END showNextArrow:empty --\x3e>\n\t\t\t\t\t<a\n\t\t\t\t\t\thref="#"\n\t\t\t\t\t\tdata-action-click="gotoSlide({next})"\n\t\t\t\t\t\trole="button">\n\t\t\t\t\t\t<span class="smartphoto-sr-only">\\{message.gotoNextImage\\}</span>\n\t\t\t\t\t</a>\n\t\t\t\t</li>\n\t\t\t</ul>\n\t\t\t\x3c!-- END arrows:exist --\x3e\n\n\t\t\t\x3c!-- BEGIN nav:exist --\x3e\n\t\t\t<nav\n\t\t\t\tclass="\\{classNames.smartPhotoNav\\}"\n\t\t\t\t\x3c!-- BEGIN hideUi:exist --\x3earia-hidden="true"\x3c!-- END hideUi:exist --\x3e\n\t\t\t\t\x3c!-- BEGIN hideUi:exist --\x3e aria-hidden="false"\x3c!-- END hideUi:exist --\x3e>\n\t\t\t\t<ul>\n\t\t\t\t\t\x3c!-- BEGIN groupItems:loop --\x3e\n\t\t\t\t\t<li>\n\t\t\t\t\t\t<a\n\t\t\t\t\t\t\thref="#"\n\t\t\t\t\t\t\tdata-action-click="gotoSlide({index})"\n\t\t\t\t\t\t\tclass="\x3c!-- \\BEGIN currentIndex:touch#{index} --\x3ecurrent\x3c!-- \\END currentIndex:touch#{index} --\x3e"\n\t\t\t\t\t\t\tstyle="background-image:url(\'{thumb}\');"\n\t\t\t\t\t\t\trole="button">\n\t\t\t\t\t\t\t<span class="smartphoto-sr-only">go to {caption}</span>\n\t\t\t\t\t\t</a>\n\t\t\t\t\t</li>\n\t\t\t\t\t\x3c!-- END groupItems:loop --\x3e\n\t\t\t\t</ul>\n\t\t\t</nav>\n\t\t\t\x3c!-- END nav:exist --\x3e\n\n\t\t\t<button\n\t\t\t\tclass="\\{classNames.smartPhotoDismiss\\}"\n\t\t\t\tdata-action-click="hidePhoto()">\n\t\t\t\t<span class="smartphoto-sr-only">\\{message.closeDialog\\}</span>\n\t\t\t</button>\n\t\t</div>\n\t\t\x3c!-- BEGIN appearEffect:exist --\x3e\n\t\t<img src=\\{appearEffect.img\\}\n\t\tclass="\\{classNames.smartPhotoImgClone\\}"\n\t\tstyle="width:\\{appearEffect.width\\}px;height:\\{appearEffect.height\\}px;transform:translate(\\{appearEffect.left\\}px,\\{appearEffect.top\\}px) scale(1)" />\n\t\t\x3c!-- END appearEffect:exist --\x3e\n\t</div>\n</div>\n',
          p = t('../lib/util'),
          ...
          y = (function (t) {
            function e(t, a) {
              var o;
              n(this, e),
                (o = s(this, d(e).call(this))),
                (o.data = p.extend({}, g, a)),
                (o.data.currentIndex = 0),
                (o.data.oldIndex = 0),
                (o.data.hide = !0),
                (o.data.group = {}),
                (o.data.scaleSize = 1),
                ...
                (o.data.photoPosY = 0),
                (o.handlers = []),
                (o.convert = { increment: o.increment, virtualPos: o.virtualPos, round: o.round }),
                (o.data.groupItems = o.groupItems),
                (o.elements = 'string' == typeof t ? document.querySelectorAll(t) : t);
              var i = new Date();
              (o.tapSecond = i.getTime()),
                (o.onListMove = !1),
                (o.clicked = !1),
                (o.id = o._getUniqId()),
                (o.vx = 0),
                (o.vy = 0),
                (o.data.appearEffect = null),
                o.addTemplate(o.id, f),
                (o.data.isSmartPhone = o._isSmartPhone());
              var r = document.querySelector('body');
              p.append(r, "<div data-id='".concat(o.id, "'></div>")),
                [].forEach.call(o.elements, function (t) {
                  o.addNewItem(t);
                }),
                o.update();
              var c = o._getCurrentItemByHash();
              if (
                (c && p.triggerEvent(c.element, 'click'),
                (o.interval = setInterval(function () {
                  o._doAnim();
                }, o.data.forceInterval)),
                !o.data.isSmartPhone)
              ) {
                var u = function () {
                    o.groupItems() &&
                      (o._resetTranslate(),
                      o._setPosByCurrentIndex(),
                      o._setSizeByScreen(),
                      o.update());
                  },
                  l = function (t) {
                    ...
                    !0 !== o.data.hide &&
                      (37 === e
                        ? o.gotoSlide(o.data.prev)
                        : 39 === e
                        ? o.gotoSlide(o.data.next)
                        : 27 === e && o.hidePhoto());
                  };
                return (
                  window.addEventListener('resize', u),
                  window.addEventListener('keydown', l),
                  o._registerRemoveEvent(window, 'resize', u),
                  o._registerRemoveEvent(window, 'keydown', l),
                  s(o)
                );
              }
              var h = function () {
              ...
              if (
                ...
                o._registerRemoveEvent(window, 'orientationchange', h),
                !o.data.useOrientationApi)
              )
                return s(o);
              var m = function (t) {
                var e = window,
                ...
                t &&
                  ...
                  (o.isBeingZoomed ||
                    ...
                    !o.data.scale ||
                    (0 === a
                      ? o._calcGravity(t.gamma, t.beta)
                      : 90 === a
                      ? o._calcGravity(t.beta, t.gamma)
                      : -90 === a
                      ? o._calcGravity(-t.beta, -t.gamma)
                      : 180 === a && o._calcGravity(-t.gamma, -t.beta)));
              };
              return (
                window.addEventListener('deviceorientation', m),
                o._registerRemoveEvent(window, 'deviceorientation', m),
                o
              );
            }
            return (
              ...
              r(e, [
                ...
                },
                {
                  ...
                  value: function (t, e, a) {
                    this.handlers.push({ target: t, event: e, handler: a });
                  },
                },
                {
                  key: 'destroy',
                ...
                },
                {
                  ...
                  value: function (t) {
                    return (
                      (t = parseInt(t, 10)) / this._getSelectedItem().scale / this.data.scaleSize
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    var n = o[a].length,
                      ...
                      c = r;
                    s &&
                      (c = s.getAttribute(this.data.lazyAttribute)
                        ? s.getAttribute(this.data.lazyAttribute)
                        : s.currentSrc
                        ? s.currentSrc
                        : s.src);
                    var d = {
                    ...
                    o[a].push(d),
                      ...
                      t.getAttribute('data-id') || t.setAttribute('data-id', n),
                    ...
                    var u = function (a) {
                      ...
                      o.loaded
                        ? (e._initPhoto(),
                          e.addAppearEffect(t, o),
                          (e.clicked = !0),
                          e.update(),
                          (i.style.overflow = 'hidden'),
                          e._fireEvent('open'))
                        : e._loadItem(o).then(function () {
                            e._initPhoto(),
                              e.addAppearEffect(t, o),
                              (e.clicked = !0),
                              e.update(),
                        ...
                        e._getElementByClass(''.concat(e.data.classNames.smartPhoto)).focus();
                      var n = e._onFocus.bind(e);
                      document.addEventListener('keydown', n),
                        e._registerRemoveEvent(window, 'keydown', n);
                    };
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    (n.width = a.offsetWidth),
                      ...
                      (n.left = o.left),
                      (n.once = !0),
                      a.getAttribute(this.data.lazyAttribute)
                        ? (n.img = a.getAttribute(this.data.lazyAttribute))
                        : (n.img = e.src);
                    var r = this._getWindowWidth(),
                      s = this._getWindowHeight(),
                      c = s - this.data.headerHeight - this.data.footerHeight;
                    'fill' === this.data.resizeStyle && this.data.isSmartPhone
                      ? (i =
                          a.offsetWidth > a.offsetHeight ? s / a.offsetHeight : r / a.offsetWidth)
                      : (n.width >= n.height
                          ? (i = e.height < c ? e.width / n.width : c / n.height)
                          : n.height > n.width &&
                            (i = e.height < c ? e.height / n.height : c / n.height),
                        n.width * i > r && (i = r / n.width));
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return new v(function (a) {
                      ...
                      (n.style.opacity = 0),
                        'bottom' === t
                          ? (i.style.transform = 'translateY('.concat(r, 'px)'))
                          : 'top' === t && (i.style.transform = 'translateY(-'.concat(r, 'px)')),
                        n.addEventListener('transitionend', s, !0);
                    });
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      this._isTouched(a)
                        ? ((t = a.touches[0].pageX), (e = a.touches[0].pageY))
                        : a.pageX && ((t = a.pageX), (e = a.pageY)),
                      { x: t, y: e }
                    );
                  },
                },
                {
                  ...
                  value: function (t) {
                    var e = t.touches;
                    return [
                      { x: e[0].pageX, y: e[0].pageY },
                      { x: e[1].pageX, y: e[1].pageY },
                    ];
                  },
                },
                {
                    ...
                    window.history &&
                      ...
                      (t
                        ? window.history.replaceState(
                            null,
                            null,
                            ''.concat(location.pathname).concat(location.search, '#').concat(t)
                          )
                        : window.history.replaceState(
                            null,
                            null,
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      ...
                      (this.onListMove = !1),
                      this.oldPos &&
                        ((n = this.oldPos.x - this.firstPos.x),
                        (i = this.oldPos.y - this.firstPos.y)),
                      this.isBeingZoomed
                        ? void this.afterGesture()
                        : this.data.scale
                        ? void this.afterPhotoDrag()
                        : p.isSmartPhone() || 0 !== n || 0 !== i
                        ? Math.abs(o) <= 500 && 0 === n && 0 === i
                          ? (this.e.preventDefault(), void this.zoomPhoto())
                          : ((this.tapSecond = a),
                            this._fireEvent('swipeend'),
                            'horizontal' === this.moveDir &&
                              (n >= this.data.swipeOffset && 0 !== this.data.currentIndex
                                ? (this.data.currentIndex -= 1)
                                : n <= -this.data.swipeOffset &&
                                  this.data.currentIndex !== t.length - 1 &&
                                  (this.data.currentIndex += 1),
                              this._slideList()),
                            void (
                              'vertical' === this.moveDir &&
                              (this.data.swipeBottomToClose && i >= this.data.swipeOffset
                                ? this.hidePhoto('bottom')
                                : this.data.swipeTopToClose && i <= -this.data.swipeOffset
                                ? this.hidePhoto('top')
                ...
                },
                {
                  ...
                  value: function () {
                    if (
                      (this.e.preventDefault(), this._isGestured(this.e) && !1 === this.onListMove)
                    )
                    ...
                    if (!this.isBeingZoomed) {
                      ...
                      if (this.isSwipable) {
                        ...
                        this.dragStart &&
                          ...
                          'horizontal' === this.moveDir
                            ? ((this.pos.x += e), (this.data.translateX = this.pos.x))
                            : (this.data.translateY = a),
                          (this.onListMove = !0),
                          (this.oldPos = t),
                          this._listUpdate();
                      }
                  ...
                  value: function () {
                    if (this.photoSwipable) {
                      ...
                      'number' == typeof o && ((this.data.photoPosX += o), (this.photoVX = o)),
                        'number' == typeof n && ((this.data.photoPosY += n), (this.photoVY = n)),
                        (this.oldPhotoPos = t),
                        this._photoUpdate();
                    }
                  },
                  ...
                  value: function () {
                    if (this.oldPhotoPos.x === this.firstPhotoPos.x && this.photoSwipable)
                      ...
                      var t = this._getSelectedItem(),
                        ...
                        n = 0;
                      if (
                        (this.data.photoPosX > e.maxX
                          ? (o = -1)
                          : this.data.photoPosX < e.minX && (o = 1),
                        this.data.photoPosY > e.maxY
                          ? (n = -1)
                          : this.data.photoPosY < e.minY && (n = 1),
                        this.data.photoPosX - e.maxX > a && 0 !== this.data.currentIndex)
                      )
                        return void this.gotoSlide(this.data.prev);
                      if (
                        e.minX - this.data.photoPosX > a &&
                      ...
                      0 === o && 0 === n
                        ...
                        : this._registerElasticForce(o, n);
                    }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (this.isBeingZoomed = !0),
                      ...
                      this.data.scaleSize < o &&
                        ((this.data.photoPosX = (1 + this.data.scaleSize - o) * n),
                        (this.data.photoPosY = (1 + this.data.scaleSize - o) * i)),
                      this.data.scaleSize < 1 || this.data.scaleSize > this._getScaleBoarder()
                        ? (this.data.hideUi = !0)
                        : (this.data.hideUi = !1),
                      (this.oldDistance = e),
                      this.e.preventDefault(),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var e,
                      ...
                      o,
                      n,
                      i = t.width * t.scale * this.data.scaleSize,
                      r = t.height * t.scale * this.data.scaleSize,
                      s = this._getWindowWidth(),
                      c = this._getWindowHeight();
                    return (
                      s > i ? ((o = (s - i) / 2), (e = -1 * o)) : ((o = (i - s) / 2), (e = -1 * o)),
                      c > r ? ((n = (c - r) / 2), (a = -1 * n)) : ((n = (r - c) / 2), (a = -1 * n)),
                      {
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    (this.data.elastic = !0),
                      1 === t
                        ? (this.data.photoPosX = n.minX)
                        : -1 === t && (this.data.photoPosX = n.maxX),
                      1 === e
                        ? (this.data.photoPosY = n.minY)
                        : -1 === e && (this.data.photoPosY = n.maxY),
                      this._photoUpdate(),
                      setTimeout(function () {
                ...
                },
                {
                  key: '_calcGravity',
                  value: function (t, e) {
                    (t > 5 || t < -5) && (this.vx += 0.05 * t),
                      !1 !== this.data.verticalGravity &&
                        (e > 5 || e < -5) &&
                        (this.vy += 0.05 * e);
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    (a.style.transform = c),
                      this.data.scale
                        ? p.addClass(a, t.smartPhotoImgOnMove)
                        : p.removeClass(a, t.smartPhotoImgOnMove),
                      this.data.elastic
                        ? p.addClass(a, t.smartPhotoImgElasticMove)
                        : p.removeClass(a, t.smartPhotoImgElasticMove),
                      this.data.hideUi
                  ...
                  value: function () {
                    ...
                    (e.style.transform = a),
                      this.data.onMoveClass
                        ? p.addClass(e, t.smartPhotoListOnMove)
                        : p.removeClass(e, t.smartPhotoListOnMove);
                  },
                },
                {
                  key: '_fireEvent',
                ...
                },
                {
                  ...
                  value: function () {
                    if (
                      ...
                      var t = this._getSelectedItem(),
                        e = this._makeBound(t);
                      this.data.photoPosX < e.minX
                        ? ((this.data.photoPosX = e.minX), (this.vx *= -0.2))
                        : this.data.photoPosX > e.maxX &&
                          ((this.data.photoPosX = e.maxX), (this.vx *= -0.2)),
                        this.data.photoPosY < e.minY
                          ? ((this.data.photoPosY = e.minY), (this.vy *= -0.2))
                          : this.data.photoPosY > e.maxY &&
                            ((this.data.photoPosY = e.maxY), (this.vy *= -0.2));
                      var a = this._getForceAndTheta(this.vx, this.vy),
                        o = a.force,
                        n = a.theta;
                      (o -= this.data.registance),
                        Math.abs(o) < 0.5 ||
                          ((this.vx = Math.cos(n) * o),
                          (this.vy = Math.sin(n) * o),
                          this._photoUpdate());
                    }
                  },
                },
                {
                  key: '_onFocus',
                  value: function (t) {
                    var e = this._getElementByClass(''.concat(this.data.classNames.smartPhoto)),
                    ...
                    'Tab' !== t.key || t.shiftKey || (n === o && (t.preventDefault(), e.focus())),
                      'Tab' === t.key && t.shiftKey && n === e && (t.preventDefault(), o.focus());
                  },
                },
              ]),
              e
    ...
    12: [
      function (t, e, a) {
        ...
        function n(t) {
          ...
          for (var e = 1; e < arguments.length; e++) {
            ...
            if (a)
              for (var i in a)
                a.hasOwnProperty(i) &&
                  ('object' === o(a[i]) ? (t[i] = n(t[i], a[i])) : (t[i] = a[i]));
          }
          return t;
        }
        Object.defineProperty(a, '__esModule', { value: !0 }),
        ...
        var s = function (t, e, a) {
          var o;
          window.CustomEvent
            ? (o = new CustomEvent(e, { cancelable: !0 }))
            : ((o = document.createEvent('CustomEvent')), o.initCustomEvent(e, !1, !1, a)),
            t.dispatchEvent(o);
        };
        a.triggerEvent = s;
        var c = function (t) {
          for (var e, a, o, n = t.split('&'), i = {}, r = 0, s = n.length; r < s; r++)
            (e = n[r].split('=')),
              void 0 !== e[0] &&
                ((a = e[0]),
                (o = void 0 !== e[1] ? e.slice(1).join('=') : a),
                (i[a] = decodeURIComponent(o)));
          return i;
        };
        a.parseQuery = c;
        var d = function (t) {
